...
The message queue is an independent module and is disabled by default. Enable it from the **Queue** tab in the extension popup, then use the on-page **Queue** button inside an existing conversation.
...
- Waits when the official composer contains a draft.
